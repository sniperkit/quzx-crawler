...
var stop_tags = []string{"php", "django", "cuda", "ionic2", "ionic-framework", "cordova", "wordpress", "laravel", "winforms", "mysql", "forms", "unity3d",
	...
	"cassandra", "google-maps-api-3", "parse.com", "react-native", "woocommerce", "amazon-s3", "jslint", "jhipster", "chart.js", "openerp",
	...
	"dropbox-api", "rabbitmq", "mono", "hangfire", "vsix", "exchange-server", "sharepoint-2013", "flux", "webforms", "imagemagick", "google-sheets-api",
	...
	"mono.cecil", "powerpoint", "exchangewebservices", "amcharts", "reactjs", "meteor", "jasper-reports", "sqlalchemy", "solaris",
	"ghprb", "bitbucket", "elastic-beanstalk", "google-search-console", "openshift", "activemq", "solr", "redux", "voicemail", "pug",
	"ejs", "react-redux", "grpc", "intel-xdk", "aws-lambda", "okta", "loopbackjs", "flowtype", "visualforce", "jsfeat", "tampermonkey",
